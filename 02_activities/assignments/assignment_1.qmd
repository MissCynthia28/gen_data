...
```         
# Your answer here... We performed linear regression to test the association between genotype (rs1861) and the continous phenotype. The regression coefficient for rs1861 is 0.96698 (p <2e-16), indicating that each additional copy of the T allele is associated with an average increase of 0.96698 units of the phenotype, suggesting positive additive effect. The significant p-value suggests evidence of an association between this SNP and the phenotype in our sample.
```
...
plot(jitter(geno_subset_A1$rs1861_C), geno_subset_A1$PHENOTYPE,
     xlab = "Genotype (rs1861: 0,1,2 copies)",
...
```         
# Your answer here... The R square of 0.08783 indicates that the additive model offers the best overall fit.
```
